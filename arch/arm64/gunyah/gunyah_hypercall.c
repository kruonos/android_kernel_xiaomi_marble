...
#ifndef ARM_SMCCC_FUNC_QUERY_CALL_UID
...
static void gunyah_hvc_1_2(const struct gunyah_smccc_1_2_regs *args,
				   struct gunyah_smccc_1_2_regs *res)
{
	register unsigned long arg0 asm("x0") = args->a0;
	register unsigned long arg1 asm("x1") = args->a1;
	register unsigned long arg2 asm("x2") = args->a2;
	register unsigned long arg3 asm("x3") = args->a3;
	register unsigned long arg4 asm("x4") = args->a4;
	register unsigned long arg5 asm("x5") = args->a5;
	register unsigned long arg6 asm("x6") = args->a6;
	register unsigned long arg7 asm("x7") = args->a7;
	register unsigned long arg8 asm("x8") = args->a8;
...
{
	struct gunyah_smccc_1_2_regs args = {
