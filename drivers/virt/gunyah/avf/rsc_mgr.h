...
static inline int
gunyah_rm_platform_pre_mem_share(struct gunyah_rm *rm,
...
static inline int
gunyah_rm_platform_post_mem_reclaim(struct gunyah_rm *rm,
				    struct gunyah_rm_mem_parcel *mem_parcel)
{
	return 0;
}

static inline int gunyah_rm_platform_pre_demand_page(
	struct gunyah_rm *rm, u16 vmid, enum gunyah_pagetable_access access,
	struct folio *folio)
{
	return 0;
}

static inline int gunyah_rm_platform_reclaim_demand_page(
	struct gunyah_rm *rm, u16 vmid, enum gunyah_pagetable_access access,
	struct folio *folio)
{
	return 0;
